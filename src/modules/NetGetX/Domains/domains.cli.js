...
import { addNewDomain } from './domainsOptions.js';
import { 
    scanAndLogCertificates
    } from './SSL/SSLCertificates.js';
...
const domainsMenu = async () => {
    try {
        ...
        const options = [
            ...
            { name: 'Scan All SSL Certificates Issued', value: 'showSSLCertificates' },
